...
public class User {
	...
	private List<Long> itemsVisited;
	...
	public User(int userID, boolean isSpecialUser)  throws IOException {
		...
		this.itemsVisited = new ArrayList<Long>();
...
//		userCell.setValue(cellLabel); // set cell's value
	...
	/**
	 * Adds a visited item to the user
	 * @param item
	 */
	public void addVisitedItem(Long item) {
		this.itemsVisited.add(item);
	}
	
	
	/**
	 * Get the list of items already visited by this user
	 * @return
	 */
	public List<Long> getItemsVisited() {
		return itemsVisited;
	}

	/**
	 * Gets the room ID the user is staying at.
	 * @return
	 */
	public int getRoom() {
		return this.room;
