...
public class UserRunnable implements Runnable { // , Cloneable
	...
	public void run() {
		...
		int iteration = 1;
//		System.out.println("***** It's RUNNING_1");
...
//		System.out.println("***** It's RUNNING_2");
		while (running) {
//			System.out.println("***** It's RUNNING_3");	
			...
			// UserRunnable's code
			if (firstTime) {
//				System.out.println("***** Enters 1st TIME");
				...
				Configuration.simulation.currentTime();
//				System.out.println("***** Exits 1st TIME");
