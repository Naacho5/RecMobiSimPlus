...
//						(int) (model.getDRAWING_ICON_DIMENSION()), (int) (model.getDRAWING_ICON_DIMENSION()), this);
				...
				if (d instanceof Item) {
					...
					im.setAttributeNS(null, "room", Long.toString(i.getRoom().getLabel())); // Added by Nacho Palacio 2025-04-17
				...
				if (d instanceof Door) {
					Door door = (Door)d;
					im.setAttributeNS(null, "room", Long.toString(door.getRoom().getLabel())); // Added by Nacho Palacio 2025-04-17
...
//						roomDoorF += 1;
						...
						im.setAttributeNS(null, "connectedDoor_"+pos, Long.toString(doorF)+"_"+Long.toString(roomDoorF)); // Added by Nacho Palacio 2025-04-17		
						pos++;
					}
				...
				if (d instanceof Stairs) {											
					...
					if(currentStairs.getRoom() != null) im.setAttributeNS(null, "room", Long.toString(currentStairs.getRoom().getLabel())); // Added by Nacho Palacio 2025-04-17
...
//				g.setColor(Color.BLACK);
        ...
        for (Room r: model.getRooms()) {
			...
			Element txt = doc.createElementNS(svgNS, "text");
			txt.setTextContent(Long.toString(r.getLabel())); // Added by Nacho Palacio 2025-04-17
...
//							(int) ((rp.getPolygon().ypoints[point] + (model.getDRAWING_ICON_DIMENSION()/2))));
				...
				pol.setAttributeNS(null, "room", Long.toString(r.getLabel())); // Added by Nacho Palacio 2025-04-17
...
//	        System.out.println("SVG creado");
	 ...
	 */
	private void drawWalls(List<Corner> corners, boolean isCompletedRoom, long label) { // Modified by Nacho Palacio 2025-04-17 (intlabel -> long label)
	 ...
	 */
	private void drawWallBetweenCorners(Corner c1, Corner c2, long label) { // Modified by Nacho Palacio 2025-04-17 (intlabel -> long label)
...
//		double cornerLimit = model.getDRAWING_ICON_DIMENSION();
		...
		line.setAttributeNS(null, "roomLabel", Long.toString(label)); // Added by Nacho Palacio 2025-04-17
...
//				(int) (2*secondCornerY+cornerLimit)/2);
        ...
        line.setAttributeNS(null, "room", Long.toString(rs.getRoom().getLabel())); // Added by Nacho Palacio 2025-04-17
