...
public class MainSimulator {
	...
	public static void main(String[] args) {
		...
		try {
		 ...
		 // Added by Nacho Palacio 2025-06-30
...
//				userInfo.reloadTables();
		...
		*/
		...
		simulationValidatorMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new Thread(() -> {
					MainSimulator.printConsole("Ejecutando tests sintéticos...", Level.WARNING);
...
//			System.out.println(e.getMessage());
	 ...
	 * Added by Nacho Palacio 2025-06-25.
	 */
	public static SystemRangeData analyzeSystemRangesDirectly(DataAccessGraphFile graphFile, DataAccessItemFile itemFile) {
